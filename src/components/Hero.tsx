    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full">
        <div className="max-w-2xl">
          ...
          >
            <h1 className="font-display text-6xl md:text-8xl lg:text-9xl font-light tracking-[0.15em] text-foreground">
              DAIM
            </h1>
          </motion.div>
          ...
          >
            <p className="font-display text-2xl md:text-3xl lg:text-4xl italic text-champagne tracking-wide">
              Wear Your Story
            </p>
          </motion.div>
